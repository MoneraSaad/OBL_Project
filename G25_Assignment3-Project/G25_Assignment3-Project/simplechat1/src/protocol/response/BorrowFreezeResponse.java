 ...
 *
 */
public class BorrowFreezeResponse implements Message {

	private static final long serialVersionUID = -7973601750797747916L;
	private String text;
	private ArrayList<User> Reader;

	public BorrowFreezeResponse(ArrayList<User> reader) {
		this.Reader = reader;
	}
	
	public BorrowFreezeResponse(String text) {
		this.text = text;
	}
	...
	public MessageType getMessageType() {
		...
		return MessageType.BORROW_FREEZE_RESPONSE;
	}
}
